...
class connector_gmail:
    def __init__(self):
        self.retrieved_delta = self.get_mail()
    ...
    def get_mail(self):
        ...
        results = service.users().messages().list(userId='me', labelIds=['INBOX']).execute() # TODO: Get delta instead of all
